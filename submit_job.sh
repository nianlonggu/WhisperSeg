...
torchrun --nproc_per_node=4 train.py --initial_model_path openai/whisper-large --model_folder model/whisperseg-large-vad-v0.1/ --train_dataset_folder data/datasets/multi_species_data/data/multi-species/train/ --gradient_accumulation_steps 1 --batch_size_per_device 16  --learning_rate 5e-6 --audio_mixing_ratio 0.5 --max_num_iterations 25000
